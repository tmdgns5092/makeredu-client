                ...
                <div class="left-part">
                    <vs-sidebar  :click-not-close="doNotClose" :hidden-background="doNotClose" v-model="chatSidebarActive">    
                        <div class="pt-2 pl-3 pr-3 pb-3  border-bottom">
                            ...
                            <p style="font-weight:700; text-align:center; padding:0.4rem 0">2학년 4반 과제</p>
                        </div>    
                            <!---
                            User List
                            --->
                    ...
                    <div class="right-part chat-container">
                        ...
                        <template v-else>
                            <div class="d-flex justify-content-center align-items-center h-100 bg-light"><h4 @click.stop="toggleChatSidebar(true)">채팅을 시작해보세요!</h4></div>
                        </template>
                    </div>    
...
<script>
import Vue from 'vue'; 
import UsersList from '../views/apps/chat/userslist.js'
export default {
  name: 'Chat',
  components: {
  },
